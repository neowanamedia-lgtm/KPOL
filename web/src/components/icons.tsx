/**
 * KPOL inline SVG icons.
 * - 외부 아이콘 라이브러리 추가 ✗ ([[kpol-pwa-performance]])
 * - 모두 24×24 viewBox, currentColor stroke 기반.
 * - 시각적으로 같은 크기로 보이도록 path는 약 18px 영역에 정렬.
 */
interface IconProps {
  className?: string;
}
...
export function SunIconFilled({ className }: IconProps) {
  return (
...
export function StarIconFilled({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function MoonIconFilled({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
