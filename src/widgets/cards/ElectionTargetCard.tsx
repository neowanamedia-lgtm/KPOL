...
export const ElectionTargetCard: React.FC<TargetCardProps & { onLongPress?: () => void }> = ({
  target,
  onOpen,
  onLongPress,
}) => {
      ...
      rightSlot={
        p ? (
          <TargetMetricBlock
            ...
            context={p.context_meta ?? (typeof p.member_count === 'number' ? `${p.member_count}곳` : undefined)}
          />
        ) : null
      }
    />
